...
#include "rosidl_runtime_c/string.h"  // name_turtle_caught
#include "rosidl_runtime_c/string_functions.h"  // name_turtle_caught
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: name_turtle_caught
  {
    const rosidl_runtime_c__String * str = &ros_message->name_turtle_caught;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: name_turtle_caught
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->name_turtle_caught.data) {
      rosidl_runtime_c__String__init(&ros_message->name_turtle_caught);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->name_turtle_caught,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'name_turtle_caught'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    ...
    (ros_message->name_turtle_caught.size + 1);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, name_turtle_caught) +
      last_member_size
      ) == ret_val;
  }
...
// already included above
// #include "rosidl_runtime_c/string.h"  // name_res
// already included above
// #include "rosidl_runtime_c/string_functions.h"  // name_res
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: name_res
  {
    const rosidl_runtime_c__String * str = &ros_message->name_res;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: name_res
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->name_res.data) {
      rosidl_runtime_c__String__init(&ros_message->name_res);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->name_res,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'name_res'\n");
      return false;
    }
  }
