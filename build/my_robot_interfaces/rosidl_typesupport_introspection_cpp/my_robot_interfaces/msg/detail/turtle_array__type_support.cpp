...
size_t size_function__TurtleArray__coordinates(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<float> *>(untyped_member);
  return member->size();
}

const void * get_const_function__TurtleArray__coordinates(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__TurtleArray__coordinates(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__TurtleArray__coordinates(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__TurtleArray__coordinates(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__TurtleArray__coordinates(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__TurtleArray__coordinates(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}

void resize_function__TurtleArray__coordinates(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TurtleArray_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::TurtleArray, coordinates),  // bytes offset in struct
    nullptr,  // default value
    size_function__TurtleArray__coordinates,  // size() function pointer
    get_const_function__TurtleArray__coordinates,  // get_const(index) function pointer
    get_function__TurtleArray__coordinates,  // get(index) function pointer
    fetch_function__TurtleArray__coordinates,  // fetch(index, &value) function pointer
    assign_function__TurtleArray__coordinates,  // assign(index, value) function pointer
    resize_function__TurtleArray__coordinates  // resize(index) function pointer
  }
};
