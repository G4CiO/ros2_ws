...
class Metaclass_SetNoise(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.srv.SetNoise')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interfaces.srv import _set_noise
...
class SetNoise(metaclass=Metaclass_SetNoise):
    from my_robot_interfaces.srv._set_noise import SetNoise_Request as Request
    from my_robot_interfaces.srv._set_noise import SetNoise_Response as Response
