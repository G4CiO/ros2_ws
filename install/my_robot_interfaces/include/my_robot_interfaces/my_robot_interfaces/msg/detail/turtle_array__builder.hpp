...
class Init_TurtleArray_coordinates
{
public:
  Init_TurtleArray_coordinates()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::my_robot_interfaces::msg::TurtleArray coordinates(::my_robot_interfaces::msg::TurtleArray::_coordinates_type arg)
  {
...
{
  return my_robot_interfaces::msg::builder::Init_TurtleArray_coordinates();
}
